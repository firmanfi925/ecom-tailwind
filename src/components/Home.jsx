        ...
        <div className="w-1/5 ">
          ...
          <div className="">
            ...
            <ul className="text-sm py-3">
              {categories.map((item, index) => {
                return (
                  <li
                    className={`flex justify-between p-1 mb-1  ${item === categorySelected ? "bg-gray-100 rounded-lg" : " "}`}
                  ...
                  >
                    ...
                    <span className="text-green-500 bg-gray-100 p-1 rounded-lg">
                      {
                        products.filter(
                          (product, productIndex) => product.category === item
                        ).length
                      }
                    </span>
                  </li>
              ...
              <li
                className={`flex justify-between p-1 mb-1  ${"all" === categorySelected ? "bg-gray-100 rounded-lg" : " "}`}
                onClick={(e) => handleCategories(e)}
                id="all"
              >
                All
          ...
          <div className="mt-4">
            ...
            <div className="mb-1 text-sm">
              <input type="radio" className="w-4 h-4" name="order"/>
              <span className="ml-2">Alphabet</span>
            </div>
